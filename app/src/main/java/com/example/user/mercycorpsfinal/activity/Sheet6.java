...
public class Sheet6 extends AppCompatActivity {
...
//        api = new ApiHelper().getApiWithCaching(getApplicationContext());
    ...
    private  void  fetchDetails(){
        ...
        Call<List<ListItem>> call = apiService.getList6();
        call.enqueue(new Callback<List<ListItem>>() {
            ...
            public void onResponse(Call<List<ListItem>> call, retrofit2.Response<List<ListItem>> response) {
                try{
                    ...
                    Toast.makeText(Sheet6.this, "Please Connect to Internet", Toast.LENGTH_SHORT).show();
                }
                adapter = new CustomAdapterList(userList, new CustomAdapterList.OnItemClickListener() {
                    @Override
                    public void onItemClick(ListItem item) {
                        Intent i = new Intent(Sheet6.this, DetailActivity.class);
